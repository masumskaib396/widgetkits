    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.fa_grab_init', function(e){
            ...
            var $self = $(this),
                ...
                if ( "none" == $icon ) {
                    $('#'+$id).val('');
                    $('#'+$id).prev('.thickbox_special').find('span').html(widgetkitsWLocalize.select_icon);
                } else {
                    $('#'+$id).val($icon);
        ...
        $(document).on('click', '.thickbox_special', function(e) {
            ...
            var wrap_parent = $(this).closest('.widgetkits-repeater-info-wrapper'),
            ...
            if( data_type === "social_links" ) {
                ...
                $('#WK_window').addClass('widgetkits-WK_window');
                ...
                var file_frame = wp.media.frames.file_frame = wp.media({
                    title: widgetkitsWLocalize.upload,
                    library: {
                        type: 'image'
                    },
                    button: {
                        text: widgetkitsWLocalize.select_img
                    },
                    multiple: false
                });
                ...
                file_frame.on('select', function(){
                    ...
                    if ( $remover.length ) {
                        ...
                        $self.after('<button style="display: inline-block;" class="sl-widget-media-remove button">'+ widgetkitsWLocalize.widgetkitsWLocalize +'</button>');
                    }
        ...
        $( ".widgetkits-repeater-info" ).sortable({
            stop:function(event, ui) {
                $('.widgetkits_special-wfield').trigger('change');
            }
        });
        $( ".widgetkits-repeater-info" ).disableSelection();
        ...
        $(document).on('click', '.repeater-control-remove', function(e){
            ...
            $item.slideUp("normal", function(){ 
                ...
                $('.widgetkits-repeater-info').find('.single-repeater-field-wrap').each(function(index){
                    var $current = $(this),
                        $number = $current.find('.repeater_num'),
                        $wrapper = $current.closest('.widgetkits-repeater-info-wrapper'),
        ...
        $(document).on('click', '.widgetkits-widget-add-item', function(e){
            e.preventDefault();
            var $self = $(this),
                $widget = $self.closest('.widget.open'),
                $widget_id = $widget.attr('id'),
                $wrapper = $self.closest('.widgetkits-repeater-info-wrapper'),
                ...
                $container = $wrapper.find('.widgetkits-repeater-info'),
            ...
            var wrap_parent = $self.closest('.widgetkits-repeater-info-wrapper'),
            data_type = wrap_parent.attr('data-field-id');
        ...
        $(document).on('click', '.single-repater-title', function(e){
            ...
            var $self = $(this),
                ...
                $wrapper = $self.closest('.widgetkits-repeater-info'),
        ...
        $(document).on('click', '.sl-widget-up-btn', function(e){
            ...
            file_frame.on('select', function(){
                ...
                if ( $remover.length ) {
                    ...
                    $self.after('<button style="display: inline-block;" class="sl-widget-media-remove button" data-url="'+ widgetkitsWLocalize.home_url +'">'+ widgetkitsWLocalize.remove_img +'</button>');
                }
                $input.trigger('change');
            });
